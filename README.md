...
- Full-stack project with separate **backend** and **frontend** applications.
...
Tourism in Tuscany is diverse and dynamic. This dashboard aims to provide clarity on:
- Visitor flows across Tuscany’s municipalities and provinces.
- Seasonal and long-term tourism trends.
- Popularity of different destinations.
- Insights that can support sustainable tourism planning and promote lesser-known areas.
...
- Sample tourism/statistical datasets (if included)
